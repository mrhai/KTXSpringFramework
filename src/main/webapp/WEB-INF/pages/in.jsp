			...
			<table>
				<tr>
					<td><input type="radio" id="sv" name="in" onclick="ins()"
						checked="checked">Sinh viên</input></td>
					<td><input type="radio" id="nv" name="in" onclick="ins()">Nhân
						viên</input></td>
					<td><input type="radio" id="emptyroom" name="in"
						onclick="ins()">Phong</input></td>
					<td><input type="radio" id="guest" name="in"
						onclick="ins()">Khách</input></td>
					<td><input type="radio" id="device" name="in"
						onclick="ins()">Vật tư</input></td>
				</tr>
			</table>
