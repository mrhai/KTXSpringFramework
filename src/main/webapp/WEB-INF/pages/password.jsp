...
<script src="/HelloSpringMVCs/static/js/checklogin.js"
...
<body>
	...
	<div id="center">
		...
		<c:if test="${actor == 'admin' }">
			<jsp:include page="components/adminnav.jsp" /></c:if>
		<c:if test="${actor == 'sv' }">
			<jsp:include page="components/studentnav.jsp" /></c:if>
